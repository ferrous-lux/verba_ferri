/* @ts-self-types="./verba_ferri.d.ts" */

export class GameUI {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        GameUIFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gameui_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.gameui_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        GameUIFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    new_game() {
        wasm.gameui_new_game(this.__wbg_ptr);
    }
    share() {
        const ret = wasm.gameui_share(this.__wbg_ptr);
        if (ret[1]) {
    ...
    submit_guess(guess) {
        ...
        const ret = wasm.gameui_submit_guess(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    toggle_answer() {
        wasm.gameui_toggle_answer(this.__wbg_ptr);
    }
}
if (Symbol.dispose) GameUI.prototype[Symbol.dispose] = GameUI.prototype.free;

/**
 * @returns {number}
 */
export function dictionary_size() {
    const ret = wasm.dictionary_size();
    return ret >>> 0;
}
 ...
 * @returns {any}
 */
export function submit_guess(guess) {
    const ptr0 = passStringToWasm0(guess, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.submit_guess(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_set_disabled_18e02c955d0a0bdd: function(arg0, arg1) {
            arg0.disabled = arg1 !== 0;
        },
        __wbg_set_textContent_5c5fef072bd24f7a: function(arg0, arg1, arg2) {
            arg0.textContent = arg1 === 0 ? undefined : getStringFromWasm0(arg1, arg2);
        },
        __wbg_set_text_71ac7040c4630beb: function(arg0, arg1, arg2) {
        ...
        __wbg_share_d5b88a76cc475c3f: function(arg0, arg1) {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hb7ccabe4a4a3591c);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h7fa3155db28d0212);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./verba_ferri_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h7fa3155db28d0212(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h7fa3155db28d0212(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__hb7ccabe4a4a3591c(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__hb7ccabe4a4a3591c(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

const GameUIFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gameui_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('verba_ferri_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
